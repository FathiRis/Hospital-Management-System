...
(1, 1, DATE_SUB(CURDATE(), INTERVAL 30 DAY), 'Hypertension', 'Prescribed medication and lifestyle changes', 'Patient responding well to treatment'),
(2, 2, DATE_SUB(CURDATE(), INTERVAL 15 DAY), 'Common cold', 'Rest and fluids', 'Symptoms resolved');

-- Sample billing
INSERT INTO billing (patient_id, appointment_id, amount, billing_date, due_date, status) VALUES
(1, 1, 150.00, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 30 DAY), 'Unpaid'),
(2, 2, 120.00, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 30 DAY), 'Paid');