...
$db->query("SELECT COUNT(*) as total FROM appointments WHERE DATE(appointment_date) = CURDATE() AND status = 'Scheduled'");
...
$db->query("SELECT COUNT(*) as total FROM prescriptions WHERE status = 'Pending'");
...
$todays_appointments = $db->resultset();
?>
        ...
        <div class="main-content">
            ...
            <div class="dashboard-grid">
                <div class="dashboard-card">
                    ...
                    <div class="card-change">Total scheduled</div>
                </div>
                ...
                <div class="dashboard-card">
                    ...
                    <div class="card-change">Awaiting confirmation</div>
                </div>
                ...
                <div class="dashboard-card">
                    ...
                    <div class="card-change">Require processing</div>
                </div>
                ...
                <div class="dashboard-card">
                    ...
                    <div class="card-value"><?php echo $pending_prescriptions; ?></div>
                    <div class="card-change">To be filled</div>
                </div>
            </div>
            ...
            <div class="table-container">
                <div class="table-header">
                    ...
                    <a href="add_appointment.php" class="btn-primary">Add Appointment</a>
                </div>
