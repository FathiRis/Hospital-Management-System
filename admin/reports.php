...
$db->query("SELECT SUM(amount) as total FROM billing WHERE status = 'Paid' AND DATE_FORMAT(billing_date, '%Y-%m') = :month");
$db->bind(':month', $current_month);
...
$db->query("SELECT d.department, COUNT(a.appointment_id) as total_appointments 
           FROM appointments a 
        ...
        <div class="main-content">
            ...
            <div class="form-container">
                <div class="form-header">
                    <h3 class="form-title">Export Reports</h3>
                </div>
                
                <div class="dashboard-grid">
                    <div class="dashboard-card" onclick="exportReport('patients')" style="cursor: pointer;">
                        <div class="card-header">
                        ...
                        <p>Export patient list and statistics</p>
                    </div>
                    
                    <div class="dashboard-card" onclick="exportReport('appointments')" style="cursor: pointer;">
                        <div class="card-header">
                        ...
                        <p>Export appointment data</p>
                    </div>
                    
                    <div class="dashboard-card" onclick="exportReport('financial')" style="cursor: pointer;">
                        <div class="card-header">
                        ...
                        <p>Export billing and revenue data</p>
                    </div>
                </div>
            </div>
        </div>
