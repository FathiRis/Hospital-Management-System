            ...
            <div class="form-container">
                <div class="form-header">
                    ...
                    <div>
                        ...
                        <a href="appointments.php" class="btn-primary" style="background: #6c757d; margin-left: 10px;">Back to List</a>
                    </div>
                </div>
                ...
                <div class="dashboard-grid">
                    <div class="dashboard-card">
                        ...
                        <p><strong>Phone:</strong> <?php echo $appointment['phone'] ?: 'N/A'; ?></p>
                    </div>
